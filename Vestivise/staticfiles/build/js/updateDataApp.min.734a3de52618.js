...
/***/ function(module, exports, __webpack_require__) {
	...
	var _updateDataView = __webpack_require__(486);

	var _updateDataView2 = _interopRequireDefault(_updateDataView);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var root = document.getElementById('updateDataApp');

	_reactDom2.default.render(_react2.default.createElement(_updateDataView2.default, null), root);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UpdateDataView = function (_React$Component) {
	    _inherits(UpdateDataView, _React$Component);

	    function UpdateDataView(props) {
	        _classCallCheck(this, UpdateDataView);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UpdateDataView).call(this, props));

	        _this.displayName = 'UpdateDataView';
	        return _this;
	    }

	    _createClass(UpdateDataView, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            window.loading_screen = window.pleaseWait({
	                logo: "",
	                backgroundColor: '#F24258',
	                loadingHtml: "<div class='sk-cube-grid'>" + "<div class='sk-cube sk-cube1'></div>" + "<div class='sk-cube sk-cube2'></div>" + "<div class='sk-cube sk-cube3'></div>" + "<div class='sk-cube sk-cube4'></div>" + "<div class='sk-cube sk-cube5'></div>" + "<div class='sk-cube sk-cube6'></div>" + "<div class='sk-cube sk-cube7'></div>" + "<div class='sk-cube sk-cube8'></div>" + "<div class='sk-cube sk-cube9'></div>" + "</div>" + "<h1 id='loaderLabel'> Updating Data </h1>"
	            });

	            _api2.default.post(Urls.updateData(), null).done(function (res) {
	                console.log(res);
	...
	exports.default = UpdateDataView;
