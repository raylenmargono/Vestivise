...
/***/ function(module, exports, __webpack_require__) {
	...
	var _registerView = __webpack_require__(400);

	var _registerView2 = _interopRequireDefault(_registerView);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var root = document.getElementById('registerApp');

	_reactDom2.default.render(_react2.default.createElement(_registerView2.default, null), root);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RegisterView = function (_React$Component) {
	    ...
	    function RegisterView(props) {
	        ...
	        _this.displayName = 'RegisterView';
	    ...
	    _createClass(RegisterView, [{
	        ...
	        value: function register(e) {
	            ...
	            API.post(Urls.register(), payload).done(function (res) {
	                console.log('user registered');
	                API.post(Urls.login(), { 'username': username, 'password': password }).done(function (res) {
	        ...
	        key: 'setBirthday',
	        value: function setBirthday(event, date) {
	            this.setState({
	                birthday: date.getFullYear() + "-" + date.getMonth() + "-" + date.getDate()
	            });
	        }
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col m12' },
	                            _react2.default.createElement('img', { id: 'logo', src: '../../static/media/logo.jpg' })
	                        )
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        _react2.default.createElement(
	                                            ...
	                                            _react2.default.createElement(
	                                                ...
	                                                _react2.default.createElement('input', { ref: 'username', id: 'username', type: 'text', className: this.handleError('username') ? "invalid" : "", required: true }),
	                                                _react2.default.createElement(
	                                                    'label',
	                                                    { 'data-error': this.handleError('username'), htmlFor: 'username' },
	                                                    'Username'
	                                                )
	                                            )
	                                        ),
	                                        _react2.default.createElement(
	                                            ...
	                                            _react2.default.createElement(
	                                                'div',
	                                                { className: 'input-field col s12' },
	                                                _react2.default.createElement('input', { ref: 'password', id: 'password', type: 'password', className: this.handleError('password') ? "invalid" : "", required: true }),
	                                                _react2.default.createElement(
	                                                    'label',
	                                                    { 'data-error': this.handleError('password'), htmlFor: 'password' },
	                                                    'Password'
	                                                )
	                                            )
	                                        ),
	                                        _react2.default.createElement(
	                                            ...
	                                            _react2.default.createElement(
	                                                'div',
	                                                { className: 'input-field col s12' },
	                                                _react2.default.createElement('input', { ref: 'email', id: 'email', type: 'email', className: this.handleError('email') ? "invalid" : "", required: true }),
	                                                _react2.default.createElement(
	                                                    'label',
	                                                    { 'data-error': this.handleError('email'), htmlFor: 'email' },
	                                                    'Email'
	                                                )
	                                            )
	                                        ),
	                                        _react2.default.createElement(
	                                            ...
	                                            _react2.default.createElement(
	                                                ...
	                                                _react2.default.createElement('input', { ref: 'firstName', id: 'firstName', type: 'text', className: this.handleError('firstName') ? "invalid" : "", required: true }),
	                                                _react2.default.createElement(
	                                                    'label',
	                                                    { 'data-error': this.handleError('firstName'), htmlFor: 'firstName' },
	                                                    'First Name'
	                                                )
	                                            ),
	                                            _react2.default.createElement(
	                                                'div',
	                                                { className: 'input-field col s6' },
	                                                _react2.default.createElement('input', { ref: 'lastName', id: 'lastName', type: 'text', className: this.handleError('lastName') ? "invalid" : "", required: true }),
	                                                _react2.default.createElement(
	                                                    'label',
	                                                    { 'data-error': this.handleError('lastName'), htmlFor: 'lastName' },
	                                                    'Last Name'
	                                                )
	                                            )
	                                        ),
	                                        _react2.default.createElement(
	                                            ...
	                                            _react2.default.createElement(
	                                                ...
	                                                _react2.default.createElement('input', { ref: 'income', id: 'income', type: 'text', className: this.handleError('income') ? "invalid" : "", required: true }),
	                                                _react2.default.createElement(
	                                                    'label',
	                                                    { 'data-error': this.handleError('income'), htmlFor: 'income' },
	                                                    'Income'
	                                                )
	                                            ),
	                                            _react2.default.createElement(
	                                                ...
	                                                _react2.default.createElement(
	                                                    'label',
	                                                    { 'data-error': this.handleError('birthday'), htmlFor: 'birthday' },
	                                                    'Birthday'
	                                                ),
	                                                _react2.default.createElement('input', { defaultValue: "1995-01-01", ref: 'birthday', id: 'birthday', type: 'date', className: this.handleError('birthday') ? "invalid datepicker" : "datepicker", required: true })
	                                            ),
	                                            _react2.default.createElement(
	                                                'div',
	                                                { className: 'input-field col s4' },
	                                                _react2.default.createElement(
	                                                    'select',
	                                                    { id: 'state', defaultValue: "AL", ref: 'state' },
	                                                    _react2.default.createElement(
	                                                        'option',
	                                                        { value: 'AL' },
	                                                        'Alabama'
