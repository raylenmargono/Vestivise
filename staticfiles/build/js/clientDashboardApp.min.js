...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clientDashboardView = __webpack_require__(172);
	...
	var _clientDashboardStore = __webpack_require__(213);
	    ...
	    _createClass(ClientDashboardView, [{
	            ...
	            if (!dashboardState.isCompleted) {
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'h5',
	                        null,
	                        ' Our number monkeys are crunching - check back in a day or so.'
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'progress' },
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_floatingNav2.default, { isDemo: this.props.dashboardState.isDemo }),
	                this.getContainer()
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _descriptionFactory = __webpack_require__(198);
	...
	var ModuleSection = function (_Component) {
	    ...
	    function ModuleSection(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, (ModuleSection.__proto__ || Object.getPrototypeOf(ModuleSection)).call(this, props));
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col m2 left-align' },
	                            _react2.default.createElement(
	                                'button',
	                                { onClick: this.prevModule.bind(this), className: 'btn-flat nav-button' },
	                                _react2.default.createElement(
	                                    'i',
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col m2 right-align' },
	                            _react2.default.createElement(
	                                'button',
	                                { onClick: this.nextModule.bind(this), className: 'btn-flat nav-button' },
	                                _react2.default.createElement(
	                                    'i',
	                                    { className: 'material-icons' },
	                                    'navigate_next'
	        ...
	        value: function getModule() {
	            ...
	            switch (module.category) {
	                case _moduleGroup2.default.ASSET:
	                    return _react2.default.createElement(_assetModuleFactory2.default, { module: module });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vestiBlock = __webpack_require__(178);

	var _vestiBlock2 = _interopRequireDefault(_vestiBlock);

	var _moduleNames = __webpack_require__(180);
	...
	var AssetModuleFactory = function (_Component) {
	    ...
	    _createClass(AssetModuleFactory, [{
	        ...
	        value: function getModule() {
	            ...
	            return _react2.default.createElement(_vestiBlock2.default, { payload: payload });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VestiBlock = function (_Component2) {
	    ...
	    function VestiBlock(props) {
	        ...
	        _this2.state = {
	            colors: ["#cbdf8c", "#9cbdbe", "#f79594", "#e6ded5", "#b8d86b", "#dddddd", "#2c3e50", "#3498db"]
	        };
	        return _this2;
	    }
	    ...
	    _createClass(VestiBlock, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'chart percentage_chart' },
	                this.getBlocks()
	            );
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	var ModuleType = Object.assign({}, ReturnsModuleType, FeesModuleType, AssetModuleType, RiskModuleType);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vestiGauge = __webpack_require__(182);

	var _vestiGauge2 = _interopRequireDefault(_vestiGauge);

	var _vestiAreaLine = __webpack_require__(185);
	...
	var CostModuleFactory = function (_Component) {
	    ...
	    _createClass(CostModuleFactory, [{
	        ...
	        key: 'getCompoundInterest',
	        value: function getCompoundInterest(data) {
	            return {
	                categories: ['5 Years', '10 Years', '15 Years', '20 Years', '25 Years', '30 Years'],
	                data: [{
	                    name: "Savings",
	        ...
	        value: function getModule() {
	            ...
	            switch (module.name) {
	                case _moduleNames.ModuleType.FEES:
	                    return _react2.default.createElement(_vestiGauge2.default, { payload: this.getFeePayload(module.getData()) });
	                case _moduleNames.ModuleType.COMPOUND_INTEREST:
	                    return _react2.default.createElement(_vestiAreaLine2.default, { payload: this.getCompoundInterest(module.getData()) });
	                default:
	                    break;
	            }
	            return null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _highchartsMore = __webpack_require__(183);

	var _highchartsMore2 = _interopRequireDefault(_highchartsMore);

	var _highchartsSolidGauge = __webpack_require__(184);
	...
	var VestiGauge = function (_Component) {
	    ...
	    _createClass(VestiGauge, [{
	        ...
	        value: function renderChart() {
	            ...
	            _highcharts2.default.chart("gauge-container", _highcharts2.default.merge(gaugeOption, fillOption));
	        }
	    }, {
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { id: 'gauge-container', className: 'graph' });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	config.yAxis = (_config$yAxis = {
	    ...
	    min: 0
	}, _defineProperty(_config$yAxis, 'startOnTick', false), _defineProperty(_config$yAxis, 'endOnTick', false), _config$yAxis);
	...
	var VestiAreaLine = function (_Component) {
	    ...
	    _createClass(VestiAreaLine, [{
	        ...
	        value: function renderChart() {
	            ...
	            _highcharts2.default.chart('area-line-container', config);
	        }
	    }, {
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { id: 'area-line-container' });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vestiBar = __webpack_require__(187);
	...
	var ReturnsModuleFactory = function (_Component) {
	    ...
	    _createClass(ReturnsModuleFactory, [{
	        ...
	        value: function getReturnPayload(data) {
	            ...
	            return {
	                title: "Return Amount",
	                categories: ["One Year", "Two Year", "Three Year"],
	                data: payload
	            };
	        }
	    }, {
	        ...
	        value: function getContributionWithdrawPayload(data) {
	            ...
	            function clean(payload, title) {
	                return {
	                    name: title,
	                    data: [payload["contributions"], payload["withdraw"], payload["net"]]
	                };
	            }
	        ...
	        value: function getModule() {
	            ...
	            return _react2.default.createElement(_vestiBar2.default, { payload: payload });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	...
	var VestiBar = function (_Component) {
	    ...
	    _createClass(VestiBar, [{
	        ...
	        value: function renderChart() {
	            ...
	            _highcharts2.default.chart('bar-container', config);
	        }
	    }, {
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { className: 'chart', id: 'bar-container' });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vestiCategory = __webpack_require__(189);

	var _vestiCategory2 = _interopRequireDefault(_vestiCategory);

	var _vestiBell = __webpack_require__(190);

	var _vestiBell2 = _interopRequireDefault(_vestiBell);
	...
	var RiskModuleFactory = function (_Component) {
	    ...
	    _createClass(RiskModuleFactory, [{
	        ...
	        key: 'riskComparisonPayload',
	        value: function riskComparisonPayload(data) {
	            return {
	                sigma: data.std,
	                mean: data.mean,
	        ...
	        value: function getModule() {
	            ...
	            switch (module.name) {
	                case _moduleNames.ModuleType.RISK_PROFILE:
	                    return _react2.default.createElement(_vestiCategory2.default, { payload: this.getRiskProfilePayload(module.getData()) });
	                case _moduleNames.ModuleType.RISK_AGE_PROFILE:
	                    return _react2.default.createElement(_vestiCategory2.default, { payload: this.getRiskProfilePayload(module.getData()) });
	                case _moduleNames.ModuleType.RISK_COMPARE:
	                    return _react2.default.createElement(_vestiBell2.default, { payload: this.riskComparisonPayload(module.getData()) });
	                default:
	                    break;
	            }
	            return null;
	...
	var VestiCategory = function (_Component) {
	    ...
	    _createClass(VestiCategory, [{
	        ...
	        value: function renderChart() {
	            ...
	            var title = '<p class="tooltipped" data-position="top" data-delay="50" >' + this.props.payload.title + '.</p>';
	            config.title.text = title;

	            _highcharts2.default.chart("category-container", config);
	        }
	    }, {
	        key: 'shouldComponentUpdate',
	        value: function shouldComponentUpdate(nextProps) {
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { className: 'chart', id: 'category-container' });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VestiBell = function (_Component) {
	    _inherits(VestiBell, _Component);

	    function VestiBell(props) {
	        _classCallCheck(this, VestiBell);

	        var _this = _possibleConstructorReturn(this, (VestiBell.__proto__ || Object.getPrototypeOf(VestiBell)).call(this, props));
	    ...
	    _createClass(VestiBell, [{
	        key: 'createBellCurveData',
	        value: function createBellCurveData() {
	            var payload = this.props.payload;
	        ...
	        key: 'sortedIndex',
	        value: function sortedIndex(array, value) {
	            var low = 0,
	                high = array.length;
	        ...
	        value: function renderChart() {
	            ...
	            _highcharts2.default.chart('bell-container', config);
	        }
	    }, {
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { className: 'chart', id: 'bell-container' });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DescriptionFactory = function (_Component2) {
	    ...
	    _createClass(DescriptionFactory, [{
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'li',
	                            { className: 'collection-item' },
	                            'Your asset type split between stocks and bonds should move toward bonds as you age to stabilize your account closer to retirement because bonds are typically considered lower risk'
	                        )
	                    ),
	                    _react2.default.createElement(
	                        'h5',
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'li',
	                            { className: 'collection-item' },
	                            'Betting against the success of an asset to gain money as it goes down'
	                        )
	                    )
	                )
	            );
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'li',
	                            { className: 'collection-item' },
	                            'A bond based around a commitment that another party with meet an arrangement'
	                        ),
	                        _react2.default.createElement(
	                            'li',
	                            { className: 'collection-item' },
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'li',
	                            { className: 'collection-item' },
	                            'A bond issued by a corporation to raise money for a variety of reason'
	                        ),
	                        _react2.default.createElement(
	                            'li',
	                            { className: 'collection-item' },
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'li',
	                            { className: 'collection-item' },
	                            'A security created by transforming groups of bonds through financial engineering'
	                        )
	                    )
	                )
	            );
	        ...
	        value: function getRiskReturnProfileDescription() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'row' },
	                _react2.default.createElement(
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'ul',
	                        { className: 'collection' },
	                        _react2.default.createElement('li', { className: 'collection-item' })
	                    ),
	                    _react2.default.createElement(
	                        'h5',
	                        null,
	        ...
	        key: 'getRiskComparisonDescription',
	        value: function getRiskComparisonDescription() {
	            return _react2.default.createElement('div', null);
	        }
	    }, {
	            ...
	            switch (moduleName) {
	                case _moduleNames.ModuleType.RETURNS:
	                    return _react2.default.createElement(
	                        'p',
	                        { className: 'grey-text' },
	                        ' Your returns are compared to your age base ',
	                        _react2.default.createElement(NavShower, { onClick: this.selectDescription.bind(this, moduleName), uID: "1", text: "benchmark fund" }),
	                        ' ',
	                ...
	                case _moduleNames.ModuleType.CONTRIBUTION_WITHDRAW:
	                    return _react2.default.createElement(
	                        'p',
	                        { className: 'grey-text' },
	                        'Over the past four years you have ',
	                        _react2.default.createElement(NavShower, { onClick: this.selectDescription.bind(this, moduleName), uID: "2", text: "contributed" }),
	                        ' $',
	                        moduleData["total"]["contributions"],
	                        ', you have withdrawn $',
	                        moduleData["total"]["withdraw"],
	                        ', and you have netted a positive/negative $',
	                        moduleData["total"]["net"],
	                        '.'
	                    );
	                case _moduleNames.ModuleType.RETURNS_COMPARE:
	                    return _react2.default.createElement(
	                        ...
	                        { className: 'grey-text' },
	                        'Your age group for ',
	                        _react2.default.createElement(NavShower, { onClick: this.selectDescription.bind(this, moduleName), uID: "3", text: "comparisons" }),
	                        ' with Vestivise users is ',
	                        moduleData["ageGroup"],
	                        '.'
	                    );
	                case _moduleNames.ModuleType.FEES:
	                ...
	                case _moduleNames.ModuleType.COMPOUND_INTEREST:
	                    return _react2.default.createElement(
	                        ...
	                        moduleData["futureValue"][moduleData["futureValue"].length - 1],
	                        ' at retirement age adjusted for ',
	                        _react2.default.createElement(NavShower, { onClick: this.selectDescription.bind(this, moduleName, "inflation"), uID: "4", text: "inflation" }),
	                        '. This does not account for ',
	                        _react2.default.createElement(NavShower, { onClick: this.selectDescription.bind(this, moduleName), uID: "10", text: "taxes" }),
	                        '.'
	                    );
	                case _moduleNames.ModuleType.HOLDING_TYPE:
	                    return _react2.default.createElement(
	                        ...
	                        { className: 'grey-text' },
	                        'You have $',
	                        moduleData["totalInvested"],
	                        ' invested across ',
	                        moduleData["assetTypes"],
	                        ' ',
	                        _react2.default.createElement(NavShower, { onClick: this.selectDescription.bind(this, moduleName), uID: "5", text: "asset types" })
	                    );
	                case _moduleNames.ModuleType.STOCK_TYPE:
	                    return _react2.default.createElement(
	                        'p',
	                        ...
	                        ' ',
	                        _react2.default.createElement(NavShower, { onClick: this.selectDescription.bind(this, moduleName), uID: "6", text: "types" }),
	                        '.'
	                    );
	                case _moduleNames.ModuleType.BOND_TYPE:
	                    return _react2.default.createElement(
	                        ...
	                        Object.keys(moduleData).length,
	                        ' ',
	                        _react2.default.createElement(NavShower, { onClick: this.selectDescription.bind(this, moduleName), uID: "7", text: "types" }),
	                        '.'
	                    );
	                case _moduleNames.ModuleType.RISK_PROFILE:
	                    return _react2.default.createElement(
	                        ...
	                        { className: 'grey-text' },
	                        'Your ',
	                        _react2.default.createElement(NavShower, { onClick: this.selectDescription.bind(this, moduleName), uID: "8", text: "risk-return profile" }),
	                        ' is characterized as ',
	                ...
	                case _moduleNames.ModuleType.RISK_AGE_PROFILE:
	                    return _react2.default.createElement(
	                        ...
	                        { className: 'grey-text' },
	                        'Your ',
	                        _react2.default.createElement(NavShower, { onClick: this.selectDescription.bind(this, moduleName), uID: "9", text: "risk-age profile" }),
	                        ' is characterized as ',
	                        moduleData["riskLevel"],
	                        '.'
	                    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModuleStack = __webpack_require__(239);
	    ...
	    _createClass(DashboardStore, [{
	        ...
	        value: function bindAppListeners() {
	            this.bindListeners({
	                ...
	                fetchingModuleResultsFailed: _actions.ClientDataAction.fetchingProfileResultsFailed,
	        ...
	        value: function recievedProfileResults(data) {
	            ...
	            result["modules"].forEach(function (moduleRequest) {
	                ...
	                var module = new _Module2.default(moduleName, moduleEndpoint, category);
	                var stack = moduleStacks[category];
	        ...
	        value: function fetchingModuleResultsFailed(data) {
	            this.setState({
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ModuleSource = exports.DataSource = undefined;
	...
	var DataSource = {
	    getProfileFetch: {
	        ...
	        error: _actions.ClientDataAction.fetchingProfileResultsFailed }
	};

	var ModuleSource = {
	    fetch: function fetch(api, endpoint) {
	        return _api2.default.get(api(endpoint));
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ClientDataAction = exports.ClientAppAction = undefined;
	...
	var ClientDataAction = (_dec = (0, _decorators.createActions)(_alt2.default), _dec(_class = function () {
	    ...
	    _createClass(ClientDataAction, [{
	        key: 'fetchModule',
	        value: function fetchModule(module, api) {
	            console.warn = function () {};
	            var endpoint = module.getEndpoint();
	            _sources.ModuleSource.fetch(api, endpoint).end(function (err, res) {
	                if (err) {
...
/***/ function(module, exports) {
	 ...
	 */
	var Module = function () {
	    function Module(name, endpoint, category) {
