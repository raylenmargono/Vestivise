...
class UserData(models.Model):
    ...
    user = models.OneToOneField(
        # RAYLEN: FIELD SHOULD ALWAYS RELATE TO USERPROFILE IF RELATIONSHIP TO USER
        User,
        related_name='data',
        )
    class Meta:
...
# class shoudl not be in lower case
class holding(models.Model):
    # RAYLEN: THE FIELD DESCRIBES USER DATA NOT PORTFOLIO
