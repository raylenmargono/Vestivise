...
/***/ function(module, exports, __webpack_require__) {
	...
	var _linkAccountView = __webpack_require__(396);

	var _linkAccountView2 = _interopRequireDefault(_linkAccountView);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var root = document.getElementById('linkAccountApp');

	_reactDom2.default.render(_react2.default.createElement(_linkAccountView2.default, null), root);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinkAccountView = function (_React$Component) {
	    _inherits(LinkAccountView, _React$Component);

	    function LinkAccountView(props) {
	        _classCallCheck(this, LinkAccountView);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LinkAccountView).call(this, props));

	        _this.displayName = 'LinkAccountView';
	        return _this;
	    }

	    _createClass(LinkAccountView, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            _api2.default.post(Urls.fastLinkToken(), null).done(function (res) {
	                console.log(res);
	                var token = res.finappAuthenticationInfos[0].token;
	                var rsession = res.rsession;
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'form',
	                { id: 'fastLink', action: 'https://node.developer.yodlee.com/authenticate/restserver/', method: 'POST' },
	                _react2.default.createElement('input', { type: 'text', name: 'app', value: '10003600' }),
	                _react2.default.createElement('input', { id: 'rsession', type: 'text', name: 'rsession' }),
	                _react2.default.createElement('input', { id: 'token', type: 'text', name: 'token' }),
	                _react2.default.createElement('input', { type: 'text', name: 'redirectReq', value: 'true' }),
	                _react2.default.createElement('input', { type: 'text', name: 'extraParams', placeholer: 'Extra Params', value: 'callback=' + (0, _utils.getRootUrl)() + "/data/update", id: 'extraParams' }),
	...
	exports.default = LinkAccountView;
