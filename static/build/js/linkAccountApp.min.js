...
/***/ function(module, exports, __webpack_require__) {
	...
	var _linkAccountView = __webpack_require__(432);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(403).setImmediate, __webpack_require__(403).clearImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Q = __webpack_require__(476),
	    request = __webpack_require__(477),
	    csrfToken = __webpack_require__(117);
	...
	var API = {
	    getAppToken: rootURL + 'api/yodlee/appToken/',
	    getAccessToken: rootURL + 'api/yodlee/accessToken/',
	    getFastLinkToken: rootURL + "api/yodlee/fastLinkToken/",
	    getFastLinkiFrame: rootURL + "api/yodlee/fastLinkiFrame/"
	};

	Yodlee.prototype.post = function post(url, payload) {
	    var r = request.post(url).set('X-CSRFToken', csrfToken).type('form').send(payload);
	    return r;
	};
	...
	Yodlee.prototype.getAppToken = function getAppToken() {
	    ...
	    var url = API.getAppToken;
	    var y = this;

	    y.post(url).end(function (err, res) {
	        var body = res.body;
	        if (err || body.error) {
	            deferred.reject(err || body.error);
	        } else {
	            y.appToken = body.token;
	            deferred.resolve();
	        }
	    });
	...
	Yodlee.prototype.getAccessToken = function getAccessToken(opt) {
	    ...
	    this.getAppToken().then(function () {

	        var url = API.getAccessToken;
	        var payload = {
	            login: opt.username,
	            password: opt.password,
	            cobSessionToken: y.appToken
	        };

	        y.post(url, payload).end(function (err, res) {
	...
	Yodlee.prototype.fastLinkToken = function fastLinkToken() {

	    var deferred = Q.defer();

	    if (!this.accessToken || !this.appToken) {
	        throw new Error('Invalid Cobrand Credentials: Empty ' + (!this.accessToken ? 'app token' : 'access token'));
	    }

	    var url = API.getFastLinkToken;

	    var payload = {
	        cobSessionToken: this.appToken,
	        rsession: this.accessToken
	    };

	    this.post(url, payload).end(function (err, res) {
	...
	Yodlee.prototype.getFastLinkiFrame = function getFastLinkiFrame(rsession, token) {
	    var deferred = Q.defer();
	    if (!rsession || !token) {
	        throw new Error("Invalid parameters: Empty " + (!this.token ? "rsession" : "token"));
	    }

	    var appParam = "10003620";
	    var url = API.getFastLinkiFrame;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _yodlee = __webpack_require__(423);

	var _yodlee2 = _interopRequireDefault(_yodlee);
	...
	var LinkAccountView = function (_React$Component) {
	    ...
	    _createClass(LinkAccountView, [{
	        ...
	        value: function componentDidMount() {
	            var y = this.state.yodlee;
	            var t = this.state;

	            y.getAppToken().then(y.getAccessToken.bind(y, account)).then(y.fastLinkToken.bind(y)).done(function (res) {

	                var token = res.result.finappAuthenticationInfos[0].token;
	                var accessToken = y.accessToken;

	                $('#rsession').val(accessToken);
	                $('#token').val(token);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { type: 'text', name: 'extraParams', placeholer: 'Extra Params', value: 'callback=127.0.0.1:8000/landing', id: 'extraParams' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(403).setImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reduce = __webpack_require__(481);
	var requestBase = __webpack_require__(478);
	...
	var request = module.exports = __webpack_require__(479).bind(null, Request);
