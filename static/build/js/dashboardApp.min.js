...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashboardView = __webpack_require__(426);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(19);
	var ReactDOMComponentTree = __webpack_require__(6);
	var ReactDOMInstrumentation = __webpack_require__(169);
	var ReactInstrumentation = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var csrfToken = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNativeComponentFromComposite = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  var ReactComponentTreeDevtool = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModuleFactory = function () {
		...
		_createClass(ModuleFactory, null, [{
			key: 'createModule',
			value: function createModule(moduleName, data) {
				var module;
				switch (moduleName) {
					case _module.ModuleConst.BASIC_RISK:
						module = _react2.default.createElement(_basicRiskModule2.default, { data: data });
						break;
					case _module.ModuleConst.BASIC_RETURN:
						module = _react2.default.createElement(_basicReturnModule2.default, { data: data });
						break;
					case _module.ModuleConst.BASIC_ASSET:
						module = _react2.default.createElement(_basicAssetModule2.default, { data: data });
						break;
					case _module.ModuleConst.BASIC_FEE:
						module = _react2.default.createElement(_basicFeeModule2.default, { data: data });
						break;
				}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _alt = __webpack_require__(408);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _alt = __webpack_require__(416);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AltUtils = __webpack_require__(240);

	var utils = _interopRequireWildcard(_AltUtils);

	var _isPromise = __webpack_require__(439);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flux = __webpack_require__(436);

	var _StateFunctions = __webpack_require__(420);
	...
	var _actions = __webpack_require__(415);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transmitter = __webpack_require__(414);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AltStore = __webpack_require__(417);

	var _AltStore2 = _interopRequireDefault(_AltStore);

	var _StoreMixin = __webpack_require__(418);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashboardActions = __webpack_require__(407);
	...
	var DashboardSource = exports.DashboardSource = {
		performSearch: {
			remote: function remote(state) {
				return _api2.default.get(Urls.test_dashboardData());
			},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stack = __webpack_require__(421);

	var _dashboardActions = __webpack_require__(407);

	var _dashboardActions2 = _interopRequireDefault(_dashboardActions);

	var _dashboardSource = __webpack_require__(422);
	...
	var DashboardStore = function () {
	  ...
	  _createClass(DashboardStore, [{
	    ...
	    value: function loadBasicAccountData(data) {
	      ...
	      riskStack.pushModule(data.basicRiskModule);

	      var returnStack = this.state.returnStack;
	      returnStack.pushModule(data.basicPerformanceModule);

	      var feeStack = this.state.feeStack;
	      feeStack.pushModule(data.basicFeeModule);

	      var assetStack = this.state.assetStack;
	      assetStack.pushModule(data.basicAssetModule);
	    ...
	    value: function nextModuleInStack(stack) {
	      ...
	      switch (stack) {
	        ...
	        case _stack.StackConst.ASSET:
	          ...
	          break;
	        case _stack.StackConst.FEE:
	          stack = this.state.feeStack;
	          stack.next();
	          state = { feeStack: stack };
	          break;
	      }
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'row moduleRow' },
						_react2.default.createElement(
							'div',
							{ className: 'col s12 m6 module orange' },
							_react2.default.createElement(_assetStack2.default, { data: this.state.assetStack })
						),
						_react2.default.createElement(
							'div',
							{ className: 'col s12 m6 module green' },
							_react2.default.createElement(_returnStack2.default, { data: this.state.returnStack })
						)
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'div',
							{ className: 'col s12 m6 module purple' },
							_react2.default.createElement(_riskStack2.default, { data: this.state.riskStack })
						),
						_react2.default.createElement(
							'div',
							{ className: 'col s12 m6 module blue' },
							_react2.default.createElement(_feeStack2.default, { data: this.state.feeStack })
						)
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasicAssetModule = function (_React$Component) {
	   ...
	   _createClass(BasicAssetModule, [{
	      ...
	      value: function createBreakAssetBreakdown() {
	         if (this.props.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	fillOption.series = [{
	    ...
	    data: [],
	    dataLabels: {
	        format: '<div style="text-align:center; margin-bottom: 15px;"><span style="font-size:25px;color:' + 'white' + '">{y}%</span><br/>' + '</div>',
	        y: 0
	    }
	}];
	...
	var BasicReturnModule = function (_React$Component) {
	  ...
	  _createClass(BasicReturnModule, [{
	    ...
	    value: function getTitle() {
	      var title = "";
	      if (this.props.data) {
	        var benchmarked = this.props.data.benchmarked;
	        var n = Number(benchmarked);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { style: style, id: _module.ModuleConst.BASIC_RETURN },
	        'BasicReturnModule'
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moduleFactory = __webpack_require__(235);
	    ...
	    _createClass(AssetStack, [{
	        ...
	        value: function getCurrentModule() {
	            ...
	            if (currentModule) {
	                ...
	                var data = currentModule.getData();

	                return _moduleFactory2.default.createModule(name, data);
	            }
	            return null;
	        }
	    }, {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'fullScreen BR' },
	                    _react2.default.createElement('div', { className: 'fullScreen innerBR' })
	                )
	            );
	        }
	    }]);
	    ...
	    _createClass(FeeStack, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'fullScreen TL' },
	                    _react2.default.createElement('div', { className: 'fullScreen innerTL' })
	                )
	            );
	        }
	    }]);
	    ...
	    _createClass(ReturnStack, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'fullScreen BL' },
	                    _react2.default.createElement('div', { className: 'fullScreen innerBL' })
	                )
	            );
	        }
	    }]);
	    ...
	    _createClass(RiskStack, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'fullScreen TR' },
	                    _react2.default.createElement('div', { className: 'fullScreen innerTR' })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.Dispatcher = __webpack_require__(437);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(438);
