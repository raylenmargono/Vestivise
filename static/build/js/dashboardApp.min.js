...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashboardView = __webpack_require__(168);
	...
	_reactDom2.default.render(_react2.default.createElement(_dashboardView2.default, null), app);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assetStack = __webpack_require__(169);

	var _assetStack2 = _interopRequireDefault(_assetStack);

	var _feeStack = __webpack_require__(194);

	var _feeStack2 = _interopRequireDefault(_feeStack);

	var _riskStack = __webpack_require__(195);

	var _riskStack2 = _interopRequireDefault(_riskStack);

	var _returnStack = __webpack_require__(196);

	var _returnStack2 = _interopRequireDefault(_returnStack);

	var _dashboardStore = __webpack_require__(197);
	...
	var _menuFooter = __webpack_require__(227);
	...
	var _navBar3 = __webpack_require__(229);
	...
	var DashboardView = function (_React$Component) {
		...
		function DashboardView(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DashboardView).call(this, props));
		...
		_createClass(DashboardView, [{
			...
			value: function componentDidMount() {
				_dashboardStore2.default.listen(this.onChange.bind(this));
				_dashboardStore2.default.performSearch();
				this.setState({
			...
			value: function componentWillUnmount() {
				_dashboardStore2.default.unlisten(this.onChange.bind(this));
			}
		}, {
			key: 'onChange',
			...
			value: function getLoadedView() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ id: 'topRow', className: 'row moduleRow' },
						_react2.default.createElement(
							'div',
							{ id: 'assetContainer', className: this.getFullScreenClass() },
							_react2.default.createElement(_assetStack2.default, {
								data: this.state.assetStack
							})
						),
						_react2.default.createElement(
							'div',
							{ id: 'returnContainer', className: this.getFullScreenClass() },
							_react2.default.createElement(_returnStack2.default, {
					...
					_react2.default.createElement(
						'div',
						{ id: 'bottomRow', className: 'row moduleRow' },
						_react2.default.createElement(
							'div',
							{ id: 'riskContainer', className: this.getFullScreenClass() },
							_react2.default.createElement(_riskStack2.default, {
						...
						_react2.default.createElement(
							'div',
							{ id: 'feeContainer', className: this.getFullScreenClass() },
							_react2.default.createElement(_feeStack2.default, {
								topRowHeight: this.state.topRowHeight,
			...
			key: 'getFullScreenClass',
			value: function getFullScreenClass() {
			...
			value: function getMenuFooter() {
				if (this.state.isFullScreen && !this.state.isAnimating) {
					return _react2.default.createElement(_menuFooter2.default, { module: this.state.currentModule });
				}
				return null;
			}
		}, {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_navBar2.default, {
						navbarConst: _navBar3.NavBarConst.DASHBOARD
					}),
					_react2.default.createElement(
						'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moduleFactory = __webpack_require__(170);

	var _moduleFactory2 = _interopRequireDefault(_moduleFactory);

	var _dashboardActions = __webpack_require__(178);

	var _dashboardActions2 = _interopRequireDefault(_dashboardActions);

	var _stack = __webpack_require__(193);
	...
	var AssetStack = function (_React$Component) {
	    _inherits(AssetStack, _React$Component);

	    function AssetStack(props) {
	        _classCallCheck(this, AssetStack);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AssetStack).call(this, props));

	        _this.displayName = 'AssetStack';
	        return _this;
	    }

	    _createClass(AssetStack, [{
	        key: 'getCurrentModule',
	        value: function getCurrentModule() {
	            var stack = this.props.data;
	            var currentModule = stack.getCurrentModule();
	            console.log(currentModule);
	            if (currentModule) {
	                var name = currentModule.getModuleID();
	                var endpoint = currentModule.getEndPoint();

	                return _moduleFactory2.default.createModule(name, endpoint);
	            }
	            return null;
	        }
	    }, {
	        ...
	        value: function animate() {
	            ...
	            var stack = this.props.data;
	            var currentModule = stack.getCurrentModule();
	            _dashboardActions2.default.animate(_stack.StackConst.ASSET, currentModule.getModuleID(), currentModule.getName(), null);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _module = __webpack_require__(171);

	var _basicRiskModule = __webpack_require__(172);

	var _basicRiskModule2 = _interopRequireDefault(_basicRiskModule);

	var _basicFeeModule = __webpack_require__(173);

	var _basicFeeModule2 = _interopRequireDefault(_basicFeeModule);

	var _basicAssetModule = __webpack_require__(174);

	var _basicAssetModule2 = _interopRequireDefault(_basicAssetModule);

	var _basicReturnModule = __webpack_require__(177);

	var _basicReturnModule2 = _interopRequireDefault(_basicReturnModule);
	...
	var ModuleFactory = function () {
		...
		_createClass(ModuleFactory, null, [{
			key: 'createModule',
			value: function createModule(moduleName, endpoint) {
				var module;
				switch (moduleName) {
					case _module.ModuleConst.BASIC_RISK:
						module = _react2.default.createElement(_basicRiskModule2.default, { endpoint: endpoint });
						break;
					case _module.ModuleConst.BASIC_RETURN:
						module = _react2.default.createElement(_basicReturnModule2.default, { endpoint: endpoint });
						break;
					case _module.ModuleConst.BASIC_ASSET:
						module = _react2.default.createElement(_basicAssetModule2.default, { endpoint: endpoint });
						break;
					case _module.ModuleConst.BASIC_FEE:
						module = _react2.default.createElement(_basicFeeModule2.default, { endpoint: endpoint });
						break;
				}
...
/***/ function(module, exports) {
	...
	var ModuleConst = exports.ModuleConst = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	config.tooltip = {
	    formatter: function formatter() {
	        ...
	        var tooltips = ["If you have a high amount of risk, and you're not getting very much money from them, you will end in the lower end of the gauge", "If you have a portfolio that is making good returns, but is fairly risky, it'll end up in the middle end of the gauge", "If you have a low amount of risk, and a high amount of returns, then your portfolio will end up in the very high end of the gauge"];
	...
	var BasicRiskModule = function (_React$Component) {
	    _inherits(BasicRiskModule, _React$Component);

	    function BasicRiskModule(props) {
	        _classCallCheck(this, BasicRiskModule);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BasicRiskModule).call(this, props));

	        _this.displayName = 'BasicRiskModule';
	        return _this;
	    }

	    _createClass(BasicRiskModule, [{
	        key: 'getData',
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { style: style, id: _module.ModuleConst.BASIC_RISK });
	        }
	    }]);

	    return BasicRiskModule;
	}(_react2.default.Component);

	exports.default = BasicRiskModule;
...
/***/ function(module, exports, __webpack_require__) {
	...
	fillOption.series = [{
	    ...
	    data: [],
	    dataLabels: {
	        format: '<div style="text-align:center; margin-bottom: 15px;"><span style="font-size:25px;color:' + '#333366' + '">{y}%</span><br/>' + '</div>',
	        y: 0
	    },
	    tooltip: {
	        valueSuffix: '%'
	...
	var BasicFeeModule = function (_React$Component) {
	    _inherits(BasicFeeModule, _React$Component);

	    function BasicFeeModule(props) {
	        _classCallCheck(this, BasicFeeModule);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BasicFeeModule).call(this, props));

	        _this.displayName = 'BasicFeeModule';
	        return _this;
	    }

	    _createClass(BasicFeeModule, [{
	        key: 'setFee',
	        ...
	        key: 'setTitleText',
	        value: function setTitleText() {
	            if (this.props.data) {
	                var text = '<p style="margin-top: 0" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="">Your fees are ' + this.props.data.averagePlacement + ' than the majority of investors</p>';
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { style: style, id: _module.ModuleConst.BASIC_FEE });
	        }
	    }]);

	    return BasicFeeModule;
	}(_react2.default.Component);

	exports.default = BasicFeeModule;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasicAssetModule = function (_React$Component) {
	    _inherits(BasicAssetModule, _React$Component);

	    function BasicAssetModule(props) {
	        _classCallCheck(this, BasicAssetModule);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BasicAssetModule).call(this, props));

	        _this.displayName = 'BasicAssetModule';
	        return _this;
	    }

	    _createClass(BasicAssetModule, [{
	        key: 'createBreakAssetBreakdown',
	        value: function createBreakAssetBreakdown(percentages) {
	            var result = [];
	        ...
	        key: 'createTitle',
	        value: function createTitle(totalAssets) {
	        ...
	        key: 'getData',
	        value: function getData() {
	            _api2.default.get(Urls.broker(this.props.endpoint)).done(function (res) {
	                this.createTitle(res.totalInvested);
	                this.createBreakAssetBreakdown(res.percentages);
	                $("#" + _module.ModuleConst.BASIC_ASSET).highcharts(config);
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { style: style, id: _module.ModuleConst.BASIC_ASSET });
	        }
	    }]);
	...
	exports.default = BasicAssetModule;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var csrfToken = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	config.xAxis = {
	    categories: ["One Month Return", "Three Month Return", "One Year Return", "Three Year Return"],
	    labels: {
	        style: {
	            color: '#434778'
	        }
	...
	var BasicReturnModule = function (_React$Component) {
	    _inherits(BasicReturnModule, _React$Component);

	    function BasicReturnModule(props) {
	        _classCallCheck(this, BasicReturnModule);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BasicReturnModule).call(this, props));

	        _this.displayName = 'BasicReturnModule';
	        return _this;
	    }

	    _createClass(BasicReturnModule, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            this.getData();
	            console.log;
	            $("#" + _module.ModuleConst.BASIC_RETURN).highcharts(config);
	        }
	    }, {
	        key: 'getData',
	        value: function getData() {
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { style: style, id: _module.ModuleConst.BASIC_RETURN });
	        }
	    }]);
	...
	exports.default = BasicReturnModule;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppActions = function () {
		...
		_createClass(AppActions, [{
			...
			key: 'dataSuccess',
			value: function dataSuccess(data) {
				return data;
			}
		}, {
			key: 'dataFail',
			value: function dataFail(error) {
				return error;
			}
		}, {
			key: 'nextModuleInStack',
			value: function nextModuleInStack(module) {
				return module;
			}
		}, {
			key: 'animate',
			value: function animate(stack, moduleID, moduleName, topRowHeight) {
				return {
					stack: stack,
...
/***/ function(module, exports) {
	...
	var StackConst = exports.StackConst = {
		RISK: 'Risk',
		RETURN: 'Return',
		COST: "Cost",
		ASSET: "Asset"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FeeStack = function (_React$Component) {
	    _inherits(FeeStack, _React$Component);

	    function FeeStack(props) {
	        _classCallCheck(this, FeeStack);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FeeStack).call(this, props));

	        _this.displayName = 'FeeStack';
	        return _this;
	    }

	    _createClass(FeeStack, [{
	        key: 'getCurrentModule',
	        value: function getCurrentModule() {
	            var stack = this.props.data;
	            var currentModule = stack.getCurrentModule();
	        ...
	        value: function animate() {
	            ...
	            var stack = this.props.data;
	            var currentModule = stack.getCurrentModule();
	            _dashboardActions2.default.animate(_stack.StackConst.COST, currentModule.getModuleID(), currentModule.getName(), this.props.topRowHeight);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RiskStack = function (_React$Component) {
	    _inherits(RiskStack, _React$Component);

	    function RiskStack(props) {
	        _classCallCheck(this, RiskStack);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RiskStack).call(this, props));

	        _this.displayName = 'RiskStack';
	        return _this;
	    }

	    _createClass(RiskStack, [{
	        key: 'getCurrentModule',
	        value: function getCurrentModule() {
	            var stack = this.props.data;
	            var currentModule = stack.getCurrentModule();
	        ...
	        value: function animate() {
	            var stack = this.props.data;
	            var currentModule = stack.getCurrentModule();
	            _dashboardActions2.default.animate(_stack.StackConst.RISK, currentModule.getModuleID(), currentModule.getName(), this.props.topRowHeight);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReturnStack = function (_React$Component) {
	    _inherits(ReturnStack, _React$Component);

	    function ReturnStack(props) {
	        _classCallCheck(this, ReturnStack);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ReturnStack).call(this, props));

	        _this.displayName = 'ReturnStack';
	        return _this;
	    }

	    _createClass(ReturnStack, [{
	        key: 'getCurrentModule',
	        value: function getCurrentModule() {
	            var stack = this.props.data;
	            var currentModule = stack.getCurrentModule();
	        ...
	        value: function animate() {
	            ...
	            var stack = this.props.data;
	            var currentModule = stack.getCurrentModule();
	            _dashboardActions2.default.animate(_stack.StackConst.RETURN, currentModule.getModuleID(), currentModule.getName(), null);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashboardSource = __webpack_require__(198);

	var _api = __webpack_require__(175);

	var _api2 = _interopRequireDefault(_api);

	var _stack2 = __webpack_require__(199);
	...
	var DashboardStore = function () {
	    function DashboardStore() {
	        ...
	        this.bindListeners({
	            nextModuleInStack: _dashboardActions2.default.nextModuleInStack,
	            loadDashboard: _dashboardActions2.default.dataLoading,
	            loadBasicAccountData: _dashboardActions2.default.dataSuccess

	        });

	        this.state = {
	            riskStack: new _stack3.default(),
	            returnStack: new _stack3.default(),
	            costStack: new _stack3.default(),
	            assetStack: new _stack3.default(),
	            isLoading: false,
	            hasLinkedAccount: false
	        };

	        this.registerAsync(_dashboardSource.DashboardSource);
	    }
	    ...
	    _createClass(DashboardStore, [{
	        ...
	        key: 'loadBasicAccountData',
	        value: function loadBasicAccountData(data) {
	            ...
	            for (var i = 0; i < data.account_modules.length; i++) {
	                var module = data.account_modules[i].module;
	                switch (module.category) {
	                    case _stack.StackConst.RISK:
	                        riskStack.pushModule(module);
	                        break;
	                    case _stack.StackConst.ASSET:
	                        assetStack.pushModule(module);
	                        break;
	                    case _stack.StackConst.RETURN:
	                        returnStack.pushModule(module);
	                        break;
	                    case _stack.StackConst.COST:
	        ...
	        key: 'animate',
	        value: function animate(payload) {

	            var stack = payload.stack;
	            var module = payload.moduleName;
	            var moduleID = payload.moduleID;
	            var topRowHeight = payload.topRowHeight;
	            ...
	            switch (stack) {
	                case _stack.StackConst.RISK:
	                    animationFunction = _dashboard2.default.animateRisk;
	                    break;
	                case _stack.StackConst.RETURN:
	                    animationFunction = _dashboard2.default.animateReturn;
	                    break;
	                case _stack.StackConst.ASSET:
	                    animationFunction = _dashboard2.default.animateAssets;
	                    break;
	                case _stack.StackConst.COST:
	                    animationFunction = _dashboard2.default.animateCost;
	                    break;
	            }

	            animationFunction(moduleID, isFullScreen, topRowHeight, handleAnimation.bind(this));
	        }
	    }, {
	        key: 'nextModuleInStack',
	        value: function nextModuleInStack(stack) {
	            var state;
	            var stack;
	            switch (stack) {
	                case _stack.StackConst.RISK:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DashboardSource = undefined;
	...
	var DashboardSource = exports.DashboardSource = {
		performSearch: {
			remote: function remote(state) {
				return _api2.default.get(Urls.account());
			},


			loading: _dashboardActions2.default.dataLoading,

			success: _dashboardActions2.default.dataSuccess,

			error: _dashboardActions2.default.dataFail,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _module = __webpack_require__(200);
	...
	var Stack = function () {
		...
		_createClass(Stack, [{
			...
			value: function pushModule(module) {
				...
				var isAddOn = module.isAddOn;
				var endpoint = module.endpoint;
				var moduleID = module.moduleID;

				var m = new _module2.default(name, account, isAddOn, endpoint, moduleID);
				this.modules.push(m);
				if (this.index == -1) {
					this.index = 0;
				}
...
/***/ function(module, exports) {
	...
	var Module = function () {
	    function Module(moduleName, account, isAddOn, endpoint, moduleID) {
	    ...
	    _createClass(Module, [{
	        ...
	        key: "getChartCSS",
	        value: function getChartCSS() {}
	    }, {
	        key: "isAddOn",
	        value: function isAddOn() {
	            return this.isAddOn;
	        }
	    }, {
	        key: "getEndPoint",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _simpleAssign = __webpack_require__(204);
	...
	var _colorManipulator = __webpack_require__(206);

	var _childUtils = __webpack_require__(207);

	var _EnhancedButton = __webpack_require__(210);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsCreateFragment = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autoPrefix = __webpack_require__(215);
	...
	var _ScaleIn = __webpack_require__(216);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsTransitionGroup = __webpack_require__(217);

	var _reactAddonsTransitionGroup2 = _interopRequireDefault(_reactAddonsTransitionGroup);

	var _ScaleInChild = __webpack_require__(220);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dom = __webpack_require__(222);

	var _dom2 = _interopRequireDefault(_dom);

	var _CircleRipple = __webpack_require__(223);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuFooter = function (_React$Component) {
	    ...
	    function MenuFooter(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MenuFooter).call(this, props));

	        _this.displayName = 'MenuFooter';
	        return _this;
	    }
	    ...
	    _createClass(MenuFooter, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { id: 'bmenu-wrapper', className: 'col l12' },
	                    _react2.default.createElement(
	                        'ul',
	                        { className: 'bottommenu' },
	                        _react2.default.createElement(
	                            'li',
	                            { className: 'bottommenu-left' },
	                            'Insights'
	                        ),
	                        _react2.default.createElement(
	                            'li',
	                            { className: 'bottommenu-center' },
	                            this.props.module.toUpperCase()
	                        ),
	                        _react2.default.createElement(
	                            'li',
	                            { className: 'bottommenu-right' },
	                            'Comparisons'
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavBar = function (_React$Component) {
		...
		_createClass(NavBar, [{
			key: 'getActive',
			value: function getActive(navbarConst, navItem) {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'nav-wrapper vestBar' },
							_react2.default.createElement(
								'a',
								{ href: Urls.dashboard(), className: 'brand-logo center' },
								_react2.default.createElement('img', { id: 'vestivise-nav-logo', src: './../static/media/logo.jpg', alt: '' })
							),
							_react2.default.createElement(
								'ul',
								{ id: 'nav-mobile', className: 'left hide-on-med-and-down nav-bar-left' },
								_react2.default.createElement(
									'li',
									{
							...
							_react2.default.createElement(
								'ul',
								{ id: 'nav-mobile', className: 'right hide-on-med-and-down nav-bar-right' },
								_react2.default.createElement(
									'li',
									{
										id: 'optionsButton',
...
/***/ function(module, exports) {
	...
	var NavBarConst = exports.NavBarConst = {
		OPTIONS: "OPTIONS",
		DASHBOARD: "DASHBOARD"
	};
