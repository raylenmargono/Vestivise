...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginView = __webpack_require__(398);

	var _loginView2 = _interopRequireDefault(_loginView);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var root = document.getElementById('loginApp');

	_reactDom2.default.render(_react2.default.createElement(_loginView2.default, null), root);
	...
	var LoginView = function (_React$Component) {
	    ...
	    _createClass(LoginView, [{
	        ...
	        value: function login(e) {
	            ...
	            _api2.default.post(Urls.login(), payload).done(function (res) {
	                if ((0, _utils.getParameterByName)('next')) {
	                    window.location.href = (0, _utils.getRootUrl)() + (0, _utils.getParameterByName)('next');
	                } else {
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        _react2.default.createElement(
	                                            ...
	                                            _react2.default.createElement(
	                                                ...
	                                                _react2.default.createElement('input', { ref: 'username', id: 'username', type: 'text', className: this.state.error ? "invalid" : "", required: true }),
	                                                _react2.default.createElement(
	                                                    'label',
	                                                    { 'data-error': this.state.error, htmlFor: 'username' },
	                                                    'Username'
	                                                )
	                                            )
	                                        ),
	                                        _react2.default.createElement(
	                                            ...
	                                            _react2.default.createElement(
	                                                'div',
	                                                { className: 'input-field col s12' },
	                                                _react2.default.createElement('input', { ref: 'password', id: 'password', type: 'password', className: this.state.error ? "invalid" : "", required: true }),
	                                                _react2.default.createElement(
	                                                    'label',
	                                                    { 'data-error': this.state.error, htmlFor: 'password' },
	                                                    'Password'
	                                                )
	                                            )
	                                        )
